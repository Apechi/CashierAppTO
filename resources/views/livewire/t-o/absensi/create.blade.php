<div class="modal fade" id="tambah_absensi" wire:ignore.self tabindex="-1" aria-labelledby="tambah_absensiLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form wire:submit='store'>
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="tambah_absensiLabel">@lang('crud.absensi.create_title')</h1>
